...
public class GetByEmailUserHandler:IRequestHandler<GetByEmailUserQuery, UserDto?>
{
    ...
    public async Task<UserDto?>Handle(GetByEmailUserQuery request, CancellationToken cancellationToken)
    {
